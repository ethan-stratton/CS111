...
@max_score(6)
@with_import('lab07', 'Library')
@with_import('lab07', 'Book')
def test_library_read_and_read_author(Book, Library):
    ...
    assert l.read_author("Charles Dickens") == 'A Tale of Two Cities has been read 1 time(s)\n' or \
    l.read_author("Charles Dickens") == 'A Tale of Two Cities has been read 1 time(s)'
    assert l.read_author("J.R.R. Tolkien") == 'The Hobbit has been read 2 time(s)\nThe Fellowship of the Ring has been read 1 time(s)\n' or \
    l.read_author("J.R.R. Tolkien") == 'The Hobbit has been read 2 time(s)\nThe Fellowship of the Ring has been read 1 time(s)'
