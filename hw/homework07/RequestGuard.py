...
class RequestGuard:
    ...
    def can_follow_link(self, url):
        ...
        for forbidden_path in self.forbidden: # previous error: used if x in y to check, when needed for loop for each linbe
...
if __name__ == "__main__":
    # #testing
    # practice = RequestGuard("https://cs111.byu.edu") # disallowed: /Projects/project04/assets/page5.html

    # print(practice.forbidden)

    # print(practice.can_follow_link("https://cs111.byu.edu/data/spectra1.txt"))

    # #print(practice.can_follow_link("https://cs111.byu.edu/Projects/Project4/images/cat.jpg"))

    # guard = RequestGuard("https://cs111.byu.edu")
    # guard.forbidden = ['/data', '/images', '/lectures']
    # print(guard.forbidden)
    # # these all pass
    # print( guard.can_follow_link('https://cs111.byu.edu/Homework/homework01'))
    # print( guard.can_follow_link('https://cs111.byu.edu/Projects/Project4/images/cat.jpg'))
    # print( not guard.can_follow_link('https://byu.edu'))
    # # these both are False
    # print( not guard.can_follow_link('https://cs111.byu.edu/images/logo.png'))
    # print( not guard.can_follow_link('https://cs111.byu.edu/data/spectra1.txt'))
    pass
